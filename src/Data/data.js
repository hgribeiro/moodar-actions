...
export const actions = [
  ...
  },
  {
    id: 4,
    photo: Acao1,
    titulo: 'Próximo nível - Trabalho Remoto',
    category: [3],
    description:
      "Some quick example text to build on the card title and make up the bulk of the card's content.",
    fulldescription:
...
export const categories = [
  { id: 0, nome: 'Webinar', color: 'info' },
  { id: 1, nome: 'Pelestra Presencial', color: 'secondary' },
  { id: 2, nome: 'Treinamento', color: 'primary' },
  { id: 3, nome: 'Ação informativa', color: 'success' },
];
